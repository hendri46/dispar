...
@Component({
  selector: 'app-modal-restaurant',
  templateUrl: './modal-restaurant.page.html',
  styleUrls: ['./modal-restaurant.page.scss'],
})
export class ModalRestaurantPage implements OnInit {
